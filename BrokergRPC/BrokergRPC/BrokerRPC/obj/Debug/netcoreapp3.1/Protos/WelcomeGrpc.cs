...
namespace BrokerRPC {
  public static partial class WorkerRegistration
  {
    ...
    static readonly grpc::Marshaller<global::BrokerRPC.WorkerMessage> __Marshaller_greet_WorkerMessage = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::BrokerRPC.WorkerMessage.Parser));
    static readonly grpc::Marshaller<global::BrokerRPC.ConfirmationResponse> __Marshaller_greet_ConfirmationResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::BrokerRPC.ConfirmationResponse.Parser));
