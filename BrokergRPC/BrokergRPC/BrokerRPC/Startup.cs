...
using BrokerRPC.Services;
using BrokerRPC.Storages;
...
namespace BrokerRPC
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<IWorkerConnection,WorkerConnectionStorage>();
            services.AddSingleton<IMessageStorage, MessageStorage>();
            services.AddGrpc();
           services.AddHostedService<BackgroundTaskHandler>();
